...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Hackathon Officer. The hackathon oversee shall oversee the planning and organisation of the annual RoboHack event. They shall coordinate with relevant ECS staff, and be on hand to run the event.
    \end{enumerate}
