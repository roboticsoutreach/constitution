...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Marketing Officer. The Marketing Officer shall oversee the design, production, and distribution of promotional materials, promotion to prospective members, and manage the society’s online presence.
        \item Technical Officer. The Technical Officer shall be responsible for overseeing any kit development work the Group may carry out, and overseeing the maintenance of the Group’s technical infrastructure.
        ...
        \item Hackathon Officer. The Hackathon Officer shall oversee the planning and organisation of the annual RoboHack event. They shall coordinate with relevant ECS staff, and be on hand to run the event.
    \end{enumerate}
