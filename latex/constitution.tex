...
\title{The Constitution of the University of Southampton Student Robotics (USSR) Society in the University of Southampton Students' Union}
\author{University of Southampton Student Robotics}
\maketitle
...
The association's name is ``University of Southampton Student Robotics'', to be known as ``USSR'' and hereinafter `the Group'.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item MiniBots Director. The MiniBots Director shall oversee all activities executed under the ``MiniBots'' brand name, and is responsible for liasing between the MiniBots organisation and the rest of the Group.
        \item SourceBots Director. The SourceBots Director shall oversee all activities executed under the ``SourceBots'' brand name, and is responsible for liasing between the SourceBots organisation and the rest of the Group.
    \end{enumerate}
